...
The agents support repo-level instruction files (`CLAUDE.md` for Claude Code, `AGENTS.md` for Codex and omp). To maintain a single source of truth, name your file `AGENTS.md` and symlink `CLAUDE.md` to it:
...
The agents will read the same instructions.
